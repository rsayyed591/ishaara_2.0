    ...
    <div style={{fontFamily: 'Inter' }}>
        <div className='c-wrapper'>
            ...
            <div className='c-card'>
                ...
                <div style={{ color: '#33D9E3', fontSize: '32px', fontWeight: '500', marginBottom: '5%' }}><Counting n={63000000}/></div>
            ...
            <div className='c-card'>
                ...
                <div style={{ color: '#33D9E3', fontSize: '32px', fontWeight: '500', marginBottom: '5%' }}><Counting n={8435000}/></div>
